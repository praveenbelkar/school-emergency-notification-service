...
import * as singleSchoolEvent from './tests/events/single_school_event.json';
//import * as allSchoolMetadataEvent from './test/events/all_school_metadata_event.json';
...
async function main() {
    ...
    let response = await handler( testJson as APIGatewayProxyEvent, context as Context);
    return response;
}
